...
<br>
 <NuxtLink to="/fun">
  ...
  <div class="flex flex-wrap -mx-1 lg:-mx-4">
          ...
          <div class="max-w-12xl px-2 py-6 mx-auto bg-white rounded-lg shadow-lg mt-2  dark:bg-gray-800" >
            <!--Card 1-->
            <div class=" w-full lg:max-w-full lg:flex">
              <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://picsum.photos/600/400/?random')" title="Mountain">
              </div>
              <div class="border-r border-b border-l border-gray-400 lg:border-l lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                <div class="mb-4" >
                  ...
                  <p class="text-gray-700 text-base">Lorem ipsum dolor sit dolor sit amet,  dolor sit amet,  dolor sit amet,  dolor sit amet,  dolor sit amet,  dolor sit amet,   consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.</p>
          ...
          <div class="mt-4 ml-4 text-xs inline-flex items-center font-bold leading-sm uppercase px-2 py-1 bg-green-200 text-green-700 rounded-full">
            # Tag
                ...
                <div class="flex items-center">
                  <img class="w-10 h-10 rounded-full mr-4" src="https://picsum.photos/32/32/?random" alt="Avatar of Writer">
                  <div class="text-sm">
