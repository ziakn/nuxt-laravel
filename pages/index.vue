    ...
    <div class="px-6 py-8">
      <div class="flex justify-between container mx-auto">
        <div class="w-full lg:w-8/12">
          ...
          <div class="max-w-12xl px-2 py-2 mx-auto bg-white rounded-lg shadow-md mt-2 dark:bg-gray-800" v-for="(data,index) in dataList" :key="index">
            <!--Card 1-->
            <div class="w-full lg:max-w-full lg:flex" >
              <div v-if="data.image" class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
